	...
	<div class="row">
		...
		<fieldset>
           	...
           	<?php if(isset($hasError)) { //If errors are found ?>
				  <p class="alert alert-danger">Computer Says NO! Please check if you've filled all the fields with valid information and try again. Thank you.</p>
				<?php } ?>
				<?php if(isset($emailSent) && $emailSent == true) { //If email is sent ?>
				  <div class="alert alert-success">
				    <p><strong>Message Successfully Sent!</strong></p>
				    <p>Thank you for using our contact form, <strong><?php echo $name;?></strong>! Computer Says YES! and we&rsquo;ll be in touch with you soon.</p>
				  </div>
				<?php } ?>
